...
function HomePage() {
    ...
    return (
        <div className="flex flex-row flex-wrap items-center justify-center gap-5 m-5">
            ...
            <NavLink className="flex items-center justify-center tracking-widest text-white transition-all bg-red-500 hover:shadow hover:bg-red-400 rounded-2xl w-72 h-52" to="rankings">Products Ranking</NavLink>
            <NavLink className="flex items-center justify-center tracking-widest text-white transition-all bg-red-500 hover:shadow hover:bg-red-400 rounded-2xl w-72 h-52" to="rankings">Clients Ranking</NavLink>
            <NavLink className="flex items-center justify-center tracking-widest text-white transition-all bg-red-500 hover:shadow hover:bg-red-400 rounded-2xl w-72 h-52" to="movements">Monetary Movements</NavLink>            
        </div>
    )
}

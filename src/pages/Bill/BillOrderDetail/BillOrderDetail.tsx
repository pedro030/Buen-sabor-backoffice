...
export const BillOrderDetail = () => {
  ...
  const { address, creationDate, id, paymode, products, statusOrder, totalPrice, user, withdrawalMode } = orders[0]
        ...
        <div className="flex flex-col gap-6 w-[80%]" >
          <div className="w-full h-32 p-5 bg-white rounded-3xl">
            <div className="flex flex-row items-center justify-between">
              ...
              <h2 className="tracking-widest">Created <span className="font-bold">{creationDate.replace(" ", " / ")}</span></h2>
            </div>
            <div className="m-3">
